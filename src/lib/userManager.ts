...
export interface TabPermissions {
  ...
  /** Tab Push Notification — selalu true untuk semua user */
  tabNotifikasi: boolean;
}
...
export const TAB_PERMISSION_LABELS: Record<keyof TabPermissions, string> = {
  ...
  tabReport: 'Laporan',
  tabNotifikasi: 'Notifikasi & Pengingat Presensi',
...
export const PERMISSION_GROUPS: { label: string; keys: (keyof TabPermissions)[] }[] = [
  {
    label: 'Menu Utama',
    keys: ['tabLogin','tabAbsen','tabLog','tabInputAktivitas','tabAktivitas','tabReview','tabIzin','tabLogPresensiInstansi','tabDatabase','tabLokasi','tabReport','tabNotifikasi'],
  },
  {
